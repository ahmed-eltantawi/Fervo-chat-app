...
import 'package:chat_with_me_now/core/helpers/vibration.dart';
import 'package:chat_with_me_now/core/view/error_view.dart';
import 'package:chat_with_me_now/features/auth/services/auth_service.dart';
import 'package:chat_with_me_now/features/auth/views/otp_view.dart';
    ...
    on<AuthEvent>((event, emit) async {
      ...
      //*================== Google Login =================
        ...
        try {
          ...
          await AuthService.makeGoogleOrFacebookUser(event.context);
          emit(LoginSuccess());
        } catch (e) {
          vibration();
      ...
      //*================== Register Event ===============
        ...
        if (!await InternetConnection().hasInternetAccess) {
          ...
          if (await AuthService.isThisEmailExists(email)) {
            vibration();
            showSnackBar(
              event.context,
